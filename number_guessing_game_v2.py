...
if difficulty == difficulty_hard:
    #chooses random number between 1 and 40 to make it harder
    random_number = random.randint(1,40)
    print("In hard difficulty, you have 2 hints and 10 tries to guess a number between 1 and 40.")
    #this defines hint number 1 for hard level
    if random_number <20:
        hint_hard_one = ("The random number is less than 20.")
    else:
        hint_hard_one = ("The random number is greater than or equal to 20.")
    #this defines hint number 2 for hard level
